...
TOOLS = [
    {
        ...
        "function": {
            "name": "get_data_df",
            "description": (
                "Run a read-only SQL query against the Sakila PostgreSQL database "
                "and return the result as a pandas dataframe. "
                "Always use PostgreSQL syntax, not MySQL syntax."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "sql_query": {
                        ...
                        "description": (
                            ...
                            "To inspect available tables, query information_schema.tables."
                        )
                    }
                },
                "required": ["sql_query"]
